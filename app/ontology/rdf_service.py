...
class RDFOntologyService:
    ...
    def resolve_field(self, raw: str) -> OntologyResolution:
        semantic_slot = {
            ...
            "current_bond_purchase_eligible": "product.current_bond_purchase_eligible",
            "bond_market_presence": "product.bond_market_presence",
            "has_sale_lot": "product.has_sale_lot",
            "has_multiple_sale_lots": "product.has_multiple_sale_lots",
            "has_trade_price_and_buy_yield_sale_lot": "product.has_trade_price_and_buy_yield_sale_lot",
